...
import time
import sys
from beagles.backend.dark.darkop import create_darkop
from beagles.backend.io import ConfigParser, DarknetConfigFile
...
class Darknet(object):
    ...
    def __init__(self, flags):
        ...
        print('config = ', flags.model, file=sys.stderr)
        self.modify = False
