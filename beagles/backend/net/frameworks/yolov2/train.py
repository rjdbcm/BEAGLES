...
def loss(self, net_out):
    ...
    self.placeholders = {
        '_probs': _probs, '_confs': _confs, '_coord': _coord, '_proid': _proid,
        '_areas': _areas, '_upleft': _upleft, '_botright': _botright
    }
...
@tf.function
def lossv2(self, y_pred, _probs, _confs, _coord, _proid, _areas, _upleft, _botright):
    """
    Takes net.out and placeholders value
    returned in batch() func above,
    to build train_op and loss
